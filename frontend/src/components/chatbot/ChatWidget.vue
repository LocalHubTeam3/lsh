...
.chat-panel > header { display: flex; align-items: center; gap: 11px; padding: 15px 16px; color: #fff; background: var(--color-primary-dark); }.bot-mark { display: grid; width: 38px; height: 38px; place-items: center; border-radius: 10px; color: var(--color-primary-dark); background: #8fc8c2; }.chat-panel header > div:nth-child(2) { display: grid; gap: 3px; }.chat-panel header strong { color: #fff; font-size: 14px; }.chat-panel header span { display: flex; align-items: center; gap: 5px; color: #c9d7da; font-size: 10px; }.chat-panel header i { width: 6px; height: 6px; border-radius: 50%; background: var(--color-accent); }.chat-panel header button { display: grid; margin-left: auto; place-items: center; padding: 7px; border: 0; color: #fff; background: transparent; }
.messages { overflow-y: auto; padding: 18px 15px 10px; background: var(--color-bg); }.message-row { display: grid; justify-items: start; margin-bottom: 13px; }.message-row.user { justify-items: end; }.bubble { max-width: 85%; padding: 11px 13px; border: 0; border-radius: 5px 14px 14px; background: var(--color-surface); box-shadow: var(--shadow-sm); font-size: 13px; line-height: 1.6; white-space: pre-wrap; }.user .bubble { border-radius: 14px 5px 14px 14px; color: #fff; background: var(--color-primary); }
